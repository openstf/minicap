...
private:
  ...
  create_virtual_display()
  {
    ...
    mConsumer = new CpuConsumer(mBufferQueue, 1, false);
    // mConsumer = getCpuConsumer();
    mConsumer->setName(String8("minicap"));
    mConsumer->setDefaultBufferSize(mDesiredWidth, mDesiredHeight);
    mConsumer->setDefaultBufferFormat(PIXEL_FORMAT_RGB_888);
  ...
  sp<CpuConsumer> getCpuConsumer()
  {
    return mClient.getCpuConsumer();
  }

  sp<BufferQueue> getBufferQueue()
  {
    return mClient.mBufferQueue;
  }
